        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
          <div class="oh-desktop">
            <div class="wow slideInRight" data-wow-delay="0s">
              <p>Sempre proporcionando hambugueres da melhor qualidade.</p>
              <ul class="footer-contacts d-inline-block d-md-block">
                <li>
                  <div class="unit unit-spacing-xs">
                    <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                    <div class="unit-body"><a class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=5511951677070">17 99663-8804</a></div>
                  </div>
                </li>
                ...
                <li>
                  <div class="unit unit-spacing-xs">
                    ...
                    <div class="unit-body"><a class="link-location" href="#">Rua 0, Bairro Santa Maria, São Paulo 23345-522</a></div>
                  </div>
                </li>
              </ul>
            </div>
