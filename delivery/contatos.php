            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="http://api.whatsapp.com/send?1=pt_BR&phone=5511951677070">11 95167-7070</a></p>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">Rua 0, Bairro Santa Maria, São Paulo 23345-522</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">patrickgaleazzi656@gmail.com</a></p>
